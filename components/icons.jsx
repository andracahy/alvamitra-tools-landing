...
const Ico = ({ d, size = 22, fill, vb = 24, children, sw = 1.9 }) => (
...
const IconFree = (p) => (<Ico {...p}><circle cx="12" cy="12" r="9" /><path d="M9.5 9.2c.4-1 1.4-1.6 2.6-1.6 1.5 0 2.6.9 2.6 2.2 0 2.4-2.9 1.8-2.9 4M12 16.6h.01" stroke="currentColor"/></Ico>);
const IconFlash = (p) => (<Ico {...p}><path d="M12 2v6l4 2-8 12 1-8-4-2 7-10Z"/></Ico>);
const IconDoc = (p) => (<Ico {...p}><path d="M6 2.5h7l5 5v14H6z"/><path d="M13 2.5v5h5M9 13h6M9 17h6"/></Ico>);
const IconDevices = (p) => (<Ico {...p}><rect x="2.5" y="4.5" width="13" height="10" rx="1.5"/><path d="M2.5 17.5h13"/><rect x="16.5" y="8.5" width="5" height="11" rx="1.2"/></Ico>);
const IconArrow = (p) => (<Ico {...p} size={p.size || 16}><path d="M5 12h14M13 6l6 6-6 6" /></Ico>);
const IconCheck = (p) => (<Ico {...p}><path d="M4 12.5l5 5 11-12" /></Ico>);

Object.assign(window, {
  IconCamera, IconEye, IconBolt, IconStorage, IconWifi, IconCpu, IconGrid, IconSliders,
  IconFree, IconFlash, IconDoc, IconDevices, IconArrow, IconCheck,
});
